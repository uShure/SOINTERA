...
const courses = [
  ...
  },
  {
    ...
    price: 60000,
    category: "haircut",
    description: "11 базовых форм стрижек. Систематизация знаний, практика на манекенах. ВНИМАНИЕ: требует базовое парикмахерское образование! Ближайшие даты: 8 сентября, 6 октября, 3 ноября, 1 декабря",
  ...
  },
  {
    ...
    price: 60000,
    category: "color",
    description: "Фундаментальная колористика без привязки к бренду. Очный курс в Творческой деревне. Ближайшие даты: 30 сентября, 6 октября, 3 ноября, 1 декабря",
    startDate: createDate(9, 30), // ИСПРАВЛЕНО: было 8 сентября, стало 30 сентября
    duration: "3 дня"
  },
  {
  ...
  },
  {
    ...
    price: 35000,
    category: "haircut",
    description: "Интенсивный онлайн курс по коротким стрижкам с куратором. Дата начала: 8 сентября",
    startDate: createDate(9, 8),
    duration: "1 день"
  },
  {
  ...
  },
  {
    ...
    price: 39000,
    category: "color",
    description: "Фундаментальная колористика онлайн. Предзаписанные видео уроки, можно начать в любое время"
  },
  {
    ...
    price: 35000,
    category: "haircut",
    description: "Онлайн курс по коротким стрижкам в записи. Предзаписанные видео уроки, можно начать в любое время"
  },
  {
  ...
  },
  {
    ...
    price: 135000,
    category: "haircut",
    description: "ВНИМАНИЕ: несмотря на название, курс требует базовое парикмахерское образование! Предзаписанные видео уроки, можно начать в любое время"
  },
  {
  ...
  },
  {
    ...
    price: 260000,
    category: "education",
    description: "Профессиональная подготовка тренеров для индустрии красоты. ВАЖНО: для участия нужно пройти программы наставников и сдать все домашние задания вовремя"
  }
];
