...
const courses = [
  ...
  },
  {
    ...
    price: 95000,
    category: "haircut",
    description: "Полный курс для парикмахеров с базовым образованием. ВНИМАНИЕ: требует базовое парикмахерское образование! Старт: 8 сентября",
  ...
  },
  {
    ...
    price: 39000,
    category: "color",
    description: "Фундаментальная колористика без привязки к бренду с поддержкой куратора Маргариты. Онлайн формат. Старт: 8 сентября",
    startDate: createDate(9, 8),
    duration: "3 месяца"
  },
  {
