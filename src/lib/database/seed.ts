...
const courses = [
  ...
  },
  {
    ...
    price: 65000,
    category: "education",
    description: "Программа наставничества для опытных колористов. Онлайн формат. Старт: 8 сентября. РАССРОЧКА: можно оформить рассрочку от школы",
    startDate: createDate(9, 8),
    duration: "3 месяца"
  },
  {
    ...
    price: 35000,
    category: "haircut",
    description: "Интенсивный онлайн курс по коротким стрижкам с куратором. Старт: каждый первый понедельник месяца. Следующий поток: 6 октября",
